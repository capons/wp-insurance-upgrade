...
<section style="background: rgb(247,247,247);min-width: 1000px;">
	<div style="height: 100%" class="insur-container clearfix">
		<div style="padding: 40px" class="row">
			...
			<div  class="col-xs-6">
				<div id="f-t-inst" class="col-xs-12">
					<div class="col-xs-12">
				...
				<div id="f-info-body" class="col-xs-12">
	...
	<div id="grey-line" class="col-xs-12">

	</div>
	<div style="padding: 10px;text-align: center" class="col-xs-12">
		<img id="creatby" src="<?php bloginfo("template_directory");?>/image/creatby.png" alt="alt">
	</div>
</section>
